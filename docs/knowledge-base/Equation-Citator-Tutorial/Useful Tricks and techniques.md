...
To keep a custom tag, we can use <span class="equation-citator-citation equation-citator-cite-equation" data-ec-kind="eq" data-ec-refs='[{&quot;file&quot;:null,&quot;crossFile&quot;:null,&quot;tag&quot;:&quot;M1&quot;}]' style="cursor: default; color: #4199df;">(<span style="text-decoration: none; cursor: pointer; color: #4199df;">M1</span>)</span>: 
> $$ k = \frac{F \Delta l}{l} \tag{M1} $$
...
> [!table:test-table] An easier way to filter important equations
