...
> [!NOTE] Title
> ```
> This is a test for the code block output for the export 
> ```
> ![[test_image.png|200]]
...
- **Equation Citations**: Tag and reference equations with `\tag{}` and `\ref{}` <span class="equation-citator-citation equation-citator-cite-eq" data-ec-kind="eq" data-ec-refs='[{&quot;file&quot;:&quot;1&quot;,&quot;tag&quot;:&quot;3.1.1&quot;}]' style="cursor: default; color: #4199df;">(<span style="text-decoration: none; cursor: pointer; color: #4199df;">3.1.1</span>)</span>[^1] 
...
$$
\Large\boxed{E = mc^2} \tag{3.1.1}
$$

To cite this equation, use `\ref{eq:1.1}` which renders as: <span class="equation-citator-citation equation-citator-cite-eq" data-ec-kind="eq" data-ec-refs='[{&quot;file&quot;:null,&quot;tag&quot;:&quot;3.1.1&quot;}]' style="cursor: default; color: #4199df;">(<span style="text-decoration: none; cursor: pointer; color: #4199df;">3.1.1</span>)</span>, 
...
Cite multiple equations with commas : 
<span class="equation-citator-citation equation-citator-cite-eq" data-ec-kind="eq" data-ec-refs='[{&quot;file&quot;:null,&quot;tag&quot;:&quot;3.1.1&quot;}]' style="cursor: default; color: #4199df;">(<span style="text-decoration: none; cursor: pointer; color: #4199df;">3.1.1</span>)</span>, <span class="equation-citator-citation equation-citator-cite-eq" data-ec-kind="eq" data-ec-refs='[{&quot;file&quot;:null,&quot;tag&quot;:&quot;3.2.1&quot;},{&quot;file&quot;:null,&quot;tag&quot;:&quot;3.2.2&quot;}]' style="cursor: default; color: #4199df;">(<span style="text-decoration: none; cursor: pointer; color: #4199df;">3.2.1~2</span>)</span> 
...
The syntax is: `$\ref{eq:footnote^{tag}}$`,  For example,  As shown in equation <span class="equation-citator-citation equation-citator-cite-eq" data-ec-kind="eq" data-ec-refs='[{&quot;file&quot;:&quot;1&quot;,&quot;tag&quot;:&quot;2.3.1&quot;}]' style="cursor: default; color: #4199df;">(<span style="text-decoration: none; cursor: pointer; color: #4199df;">2.3.1</span>)</span>[^1] from Paper A[^1]. 
...
![[test_image.png|title:minecraft  with $E= mc^2$|desc:a test minecraft picture  example fig  $a$|fig:4.1|334]]


We can use <span class="equation-citator-citation equation-citator-cite-figure" data-ec-kind="figure" data-ec-refs='[{&quot;file&quot;:null,&quot;tag&quot;:&quot;4.1&quot;}]' style="cursor: default; color: #4199df;">Fig. <span style="text-decoration: none; cursor: pointer; color: #4199df;">4.1</span></span> to cite the above **figure**. 
...
![[Excalidraw Support.png|fig:4.2|title:excalidraw-test-figure|desc:test|400]]
...
![fig:4.4|232](https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSJUGwUw60NYwnmZEKiGJtoRXpa56J1Ko0QjA&s)
...
Cite the table using: `$\ref{table:2.1}$`, rendered as <span class="equation-citator-citation equation-citator-cite-callout" data-ec-kind="callout" data-ec-refs='[{&quot;file&quot;:null,&quot;tag&quot;:&quot;2.1&quot;}]' style="cursor: default; color: #4199df;">Table. <span style="text-decoration: none; cursor: pointer; color: #4199df;">2.1</span></span>  
...
[^1]: [[tutorials/Quick Start-exported.md]]