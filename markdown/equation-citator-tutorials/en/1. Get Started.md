...
> 2. For more special needs like essay drafting, you may check [[en/Useful Tricks & techniques]] for more practical tricks that can be commonly used in this plugin. 
> 3. There are also several useful css snippets in the `tutorials/useful css snippets/` folder. You can also check them out. 

![[en/img/Equation Citator Logo.png|fig:1|title:Equation Citator|250]]
...
![[en/img/test_image.png|fig:1.3|title:minecraft|desc:a test minecraft picture example|200]]
...
![[en/img/Excalidraw Support.png|fig:1.5|414]]
...
> 
> See [[en/Useful Tricks & techniques#(1) Editing a Table Inside a Callout More Easily]] for details 
...
![Tool bar Image](en/img/panel_toolbars.png)
...
You may use this with `Auto-number tagged equations only`. see [[en/Useful Tricks & techniques#(3) Only Number Important Equations]] for details.
