...
> 2. For more special needs like essay drafting, you may check [[Equation-Citator-Tutorial/Useful Tricks and techniques]] for more practical tricks that can be commonly used in this plugin. 
...
> 
> See [[Equation-Citator-Tutorial/Useful Tricks and techniques#(1) Editing a Table Inside a Callout More Easily]] for details 
...
You may use this with `Auto-number tagged equations only`. see [[Equation-Citator-Tutorial/Useful Tricks and techniques#(3) Only Number Important Equations]] for details.
...
[^1]: [[Equation-Citator-Tutorial/Useful Tricks and techniques]]